...
def write_analyst_report_v2_viewer(
    ...
    doc = "\n".join(
        [
            ...
            "",
            "  /* ===== Render All Panes ===== */",
            "  function renderAllPanes(overview, digest, data, exploitCandidates, graphData, ipcData, ssData, credData) {",
            ...
            "  // legacy: render({});",
            "  Promise.all([loadData(), loadOverview(), loadDigest(), loadExploitCandidates(), loadGraph(), loadIPC(), loadSourceSink(), loadCredentials()])",
            "    .then(function(results) {",
            "      renderAllPanes(results[1], results[2], results[0], results[3], results[4], results[5], results[6], results[7]);",
            "    }).catch(() => {",
            "      renderAllPanes({}, {}, {}, {}, {}, {}, {}, {});",
            "    });",
            "  </script>",
